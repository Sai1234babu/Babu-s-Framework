...
public class DemoScriptwithDDTOrg {
	...
	public static void main(String[] args) throws IOException {
		...
		// TO READ DATA FROM PRORPERTYFILE
		        ...
		        String FIRSTNAME = wb.getSheet("organization").getRow(1).getCell(2).toString();
				...
				driver.findElement(By.name("accountname")).sendKeys(FIRSTNAME);
